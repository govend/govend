...
// ImportsCMD
func ImportsCMD(d, e, l, w bool, p, vendorDir string, args []string) error {

	options.TempDirs = append(options.TempDirs, vendorDir)
	...
	vendorRoot := filepath.Join(projectpath, vendorDir)
